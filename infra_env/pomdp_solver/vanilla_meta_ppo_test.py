...
value_iteration_dir = os.path.join(parent_dir, 'value_iteration')
sys.path.append(env_dir)
sys.path.append(value_iteration_dir)
...
for i in range(len(component_ids)):
    ...
    for j in range(len(budget_vals)):
        ...
        model = PPO.load(f'results/vanilla_meta_ppo/vanilla_meta_ppo')
...
np.save(f'results/vanilla_meta_ppo/ppo_avg_ttfs_all_components.npy', avg_ttfs)
np.save(f'results/vanilla_meta_ppo/ppo_replace_actions_data_all_components.npy', replace_actions_data)
np.save(f'results/vanilla_meta_ppo/ppo_inspect_actions_data_all_components.npy', inspect_actions_data)
np.save(f'results/vanilla_meta_ppo/ppo_cost_incurred_data_all_components.npy', cost_incurred_data)